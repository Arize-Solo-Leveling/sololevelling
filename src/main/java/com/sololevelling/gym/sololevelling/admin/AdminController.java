...
public class AdminController {
    ...
    public ResponseEntity<?> updateUserRole(@PathVariable UUID userId, @RequestBody RoleUpdateRequest request) {
    ...
    public ResponseEntity<Dungeon> getDungeonById(@PathVariable Long id) {
        return ResponseEntity.ok(dungeonService.getDungeonById(id));
    }

    @PostMapping("/dungeon/{userId}")
    public ResponseEntity<Dungeon> createDungeonForUser(@PathVariable UUID userId,
    ...
    public ResponseEntity<?> generateRandomDungeon(@PathVariable UUID userId) {
    ...
    public ResponseEntity<?> getQuestById(@PathVariable UUID id) {
    ...
    public ResponseEntity<?> generateRandomQuests(@PathVariable UUID userId) {
        return ResponseEntity.ok(questGenerator.pickRandomDailyQuests(userId));
    }

    @DeleteMapping("/quests/{id}")
    public ResponseEntity<?> deleteQuest(@PathVariable UUID id) throws Exception {
    ...
    public ResponseEntity<?> getWorkoutDetail(@PathVariable UUID id) throws AccessDeniedException {
